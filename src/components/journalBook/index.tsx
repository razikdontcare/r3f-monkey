    ...
    <div className="relative flex items-center w-[65%] px-2">
      ...
      <div className="relative flex-1 h-8 flex items-center">
        ...
        <input
          ...
          [&::-webkit-slider-thumb]:bg-center [&::-webkit-slider-thumb]:cursor-pointer 
          ...
          [&::-moz-range-thumb]:bg-center [&::-moz-range-thumb]:cursor-pointer"
        />
      </div>
      {/* Large 'A' Label */}
        ...
        <div className="w-1/2 pl-[5%] flex flex-col items-center">
          ...
          <div className="py-1 flex items-center">
            ...
            <div className="ml-4 flex items-center gap-2 relative text-[1vw]">
              ...
              <div
                className="w-[2vw] h-[2vw] rounded-full cursor-pointer hover:scale-110 transition-transform"
